...
// Selected Variant's value being changed real-time

let inputs = document.querySelectorAll('.product-form__input input[type="radio"]');
inputs.forEach(function(input) {
  input.addEventListener('click', function(event) {
    const selectedValue = event.target.value;
    const selectedElement = event.target.parentNode.querySelector('.form__label #selectedVal');
...
// Limitless Scrolling
  ...
  var load_more_btn = $(".coll-load-more_btn");
